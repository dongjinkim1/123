    ...
    <div ref={wrapRef} style={{ position: "relative" }}>
      <div style={{ position: "relative" }}>
        <input ref={inputRef} type="text" inputMode={inputMode || (type === "number" ? "numeric" : "text")} maxLength={maxLen}
          ...
          style={{ width: "100%", padding: "15px 36px 15px 16px", fontSize: 15, fontWeight: isFilled ? 600 : 400, border: "1.5px solid", borderColor: isFilled ? "rgba(139,108,193,0.25)" : open ? "rgba(139,108,193,0.3)" : "rgba(255,255,255,0.6)", borderRadius: 14, background: "rgba(255,255,255,0.55)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", color: isFilled ? "#3D2E5C" : "#9B8CB8", outline: "none", fontFamily: "inherit", transition: "all 0.3s", boxSizing: "border-box", boxShadow: open ? "0 0 0 3px rgba(139,108,193,0.06), 0 4px 20px rgba(139,108,193,0.06)" : isFilled ? "0 2px 12px rgba(139,108,193,0.04)" : "none" }} autoComplete="off" />
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F8F6F9", fontFamily: "'Pretendard Variable', -apple-system, sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      {/* ══ Content ══ */}
      <div style={{ position: "relative", zIndex: 1, maxWidth: 420, margin: "0 auto", padding: "0 24px 90px" }}>

        {/* ── Header ── */}
        <div style={{ paddingTop: 52, marginBottom: 32, ...sec(0, 10) }}>
          <button style={{ background: "none", border: "none", fontSize: 13, color: "#8B6CC1", cursor: "pointer", fontFamily: "inherit", fontWeight: 600, marginBottom: 28, padding: 0, display: "flex", alignItems: "center", gap: 5 }}>
          ...
          <h1 style={{ fontFamily: "'Noto Serif KR', Georgia, serif", fontSize: 28, fontWeight: 700, color: "#2E1F4E", lineHeight: 1.55, letterSpacing: -1.2, marginBottom: 10 }}>
            당신의 이야기는<br />
            <span style={{ background: "linear-gradient(135deg, #8B6CC1, #B88ED8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>언제</span> 시작되었나요
          </h1>
          <p style={{ fontSize: 13.5, color: "#9B8CB8", fontWeight: 400, lineHeight: 1.7 }}>
        ...
        <div style={{
          ...
          padding: "28px 22px 32px", boxShadow: "0 4px 16px rgba(139,108,193,0.05), 0 12px 48px rgba(100,70,150,0.07), 0 0 0 1px rgba(139,108,193,0.03)",
        }}>

          {/* ━━ 이름 ━━ */}
          <div style={{ ...sec(1, 60), marginBottom: 22 }}>
            ...
            <input ref={refName} type="text" value={name} onChange={(e) => setName(e.target.value)}
              ...
              style={{
                width: "100%", padding: "15px 16px", fontSize: 15, fontWeight: name ? 600 : 400,
          ...
          {/* ━━ 생년월일 ━━ */}
          <div style={{ ...sec(2, 50), marginBottom: 22 }}>
          ...
          {/* ━━ 시간 ━━ */}
          <div style={{ ...sec(3, 40), marginBottom: 22 }}>
            ...
            {!noTime ? (
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <button onClick={handleNoTime} style={{
                  flex: 0.85, padding: "14px 8px", borderRadius: 14, border: "1.5px solid rgba(255,255,255,0.6)",
              ...
              <div className="no-card" onClick={handleNoTime} style={{
                padding: "16px 18px", borderRadius: 14, background: "rgba(139,108,193,0.04)",
          ...
          {/* ━━ 출생지 ━━ */}
          <div style={{ ...sec(4, 30), marginBottom: 22 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
            ...
            {!noCity ? (
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <button onClick={handleNoCity} style={{
                  padding: "14px 14px", borderRadius: 14, border: "1.5px solid rgba(255,255,255,0.6)",
                  background: "rgba(255,255,255,0.45)", color: "#9B8CB8", fontSize: 13, fontWeight: 600,
          ...
          <div style={{ ...sec(5, 20), marginBottom: 0 }}>
            <label style={{ display: "block", ...lab, marginBottom: 8 }}>성별</label>
        ...
        {/* ── CTA ── */}
        <div style={{ ...sec(6, 10), marginTop: 28 }}>
