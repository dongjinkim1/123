...
// TERM_REPLACE / TERM_HINTS / applyTermHints / applyTermReplace
// → lib/term-utils.js 로 분리됨. termUtils.* 로 접근.
...
function buildUserPrompt(params, saju, gg, dw, mt, ti, strArr, mbtiObj) {
  ...
  */
  ...
  usr = termUtils.applyTermHints(usr);
  return usr;
}
...
module.exports = {
  ...
  applyTermReplace: termUtils.applyTermReplace
};
