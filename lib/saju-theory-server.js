...
function SJ_buildHapChungTheory() {
  return '### 합충우선순위\n' +
'\n' +
'사주 원국에서 같은 지지에 합과 충 또는 형이 동시에 걸릴 때, 어느 쪽이 우선하는지 판정하는 원리.\n' +
'\n' +
'■ 탐합망충\n' +
'- 합하는 두 글자가 인접하고, 충하는 글자가 멀리 있을 때\n' +
'- 합의 결합력이 충의 파괴력을 흡수하여 충이 무력화됨\n' +
'- 해석: 갈등이 있지만 조화의 힘이 더 강하여 관계가 유지됨\n' +
'\n' +
'■ 합피충파\n' +
'- 충하는 글자가 합하는 글자 바로 옆에 있을 때\n' +
'- 충의 파괴력이 합의 결합을 깨뜨림\n' +
...
'\n' +
'■ 합의 결합력 차이\n' +
'- 육합: 1대 1 결합으로 결합력 강함. 충이나 형이 인접해야 깨짐\n' +
'- 삼합: 세 글자 결합으로 결합력 강함. 가운데 글자가 충당하면 깨질 수 있음\n' +
'- 반합: 삼합 중 두 글자만 있는 불완전한 합. 결합력이 약하여 충이나 형에 쉽게 깨짐\n' +
'\n' +
'■ 해석 원칙\n' +
'- 합이 유지되면: 해당 오행의 변화를 고려, 안정적 에너지로 해석\n' +
'- 합이 깨지면: 원래 글자 각각의 독립적 작용으로 해석, 변동과 갈등 암시\n' +
...
function SJ_buildPagyeokTheory() {
  return '### 파격 이론\n' +
'\n' +
'격국이 정상적으로 기능하지 못하는 특수 상태. 정격과 해석 방향이 완전히 달라지며, 파격을 해소하는 용신이 핵심.\n' +
'\n' +
'■ 효신탈식 — 식신격 또는 편인격\n' +
'- 성립: 식신격에서 편인이 식신을 극함, 또는 편인격에서 식신이 충돌\n' +
'- 해소: 편재가 편인을 제어하면 해소\n' +
'- 해석: 재능과 표현력이 억압받는 구조. 창의성은 있으나 발휘가 막힘. 편재가 돌파구\n' +
'\n' +
'■ 상관견관 — 정관격\n' +
'- 성립: 정관격에서 상관이 정관을 극함\n' +
'- 해소: 인성이 상관을 설기시키면 해소\n' +
'- 해석: 권위와 자유가 충돌. 조직 내 마찰, 윗사람과의 갈등. 인성으로 조화\n' +
'\n' +
'■ 겁재탈재 — 정재격 또는 편재격\n' +
'- 성립: 재성격에서 겁재가 재물을 빼앗음\n' +
'- 해소: 관성이 겁재를 제어하면 해소\n' +
'- 해석: 재물 손실, 동료나 형제와의 재정 갈등. 관성으로 안정\n' +
'\n' +
'■ 칠살무제 — 편관격\n' +
'- 성립: 편관격에서 식상이 부족하여 편관을 제어 못함\n' +
'- 해소: 식상이 충분하면 제살로 해소\n' +
'- 해석: 외부 압박과 스트레스가 극심. 강한 추진력이 통제 불능. 식상으로 제어\n' +
'\n' +
'■ 재다신약\n' +
'- 성립: 신약한 사주에서 재성이 과다하고 비겁이 부족\n' +
'- 해소: 비겁이 충분하면 방신으로 해소\n' +
'- 해석: 욕심은 크나 체력과 의지가 따라가지 못함. 과로, 건강 악화 주의. 비겁이 필요\n' +
'\n' +
'■ 관살혼잡\n' +
'- 성립: 정관과 편관이 동시에 존재하고 식신으로 제어 안 됨\n' +
'- 해소: 식신이 편관을 제거하거나, 합으로 하나가 제거되면 해소\n' +
'- 해석: 이중 압박, 우유부단, 직업과 관계에서 방향성 혼란. 하나를 선택하고 집중해야 함\n' +
'\n' +
'■ 인다용재\n' +
'- 성립: 신강 사주에서 인성이 과다하고 재성이 부족\n' +
'- 해소: 재성이 인성을 제어하면 해소\n' +
'- 해석: 생각만 많고 행동력 부족, 의존적 성향. 재성으로 균형\n' +
'\n' +
'■ 파격 해석 원칙\n' +
'- 파격은 나쁜 사주가 아니라 특수한 과제를 가진 사주\n' +
'- 해소 용신이 대운이나 세운에서 오면 파격이 풀리는 전환점\n' +
