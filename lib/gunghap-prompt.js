...
【1군 — 반드시 사용】 풀이의 뼈대.
- ★★ 관계 교차 패턴 (ssom/lover 등 — 두 사람의 관계 역학)

【1.5군 — 인물 묘사의 재료】 각 사람을 묘사할 때 활용.
- ★★ 캐릭터 프로파일 (premium 패턴 — A/B 각각의 개인 특성)
- 캐릭터 프로파일에서 다양한 특성을 골라 사용하세요. 한 가지 특성(예: 에너지 강약)에 의존하지 마세요.
- 같은 사람을 묘사할 때 매 소주제마다 다른 각도를 사용하세요.
