...
function getSpecialSinsal(yg,yj,mg,mj,dg,dj,hg,hj){
  ...
  // 천덕귀인 canonical table: 자巳 축庚 인丁 묘申 진壬 사辛 오亥 미甲 신癸 유寅 술丙 해乙
  ...
  // 귀문관살: 자酉 축午 인未 묘申 진亥 사戌 (+reverse) — 천라지망 entries removed
  ...
  // 백호대살 7종 — judged by stem/branch sharing the same pillar (동주).
