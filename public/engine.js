...
교차 패턴 중 이 사람에게 해당하는 것을 골라 풀이에 녹이세요.
...
## 긍정 먼저 규칙
각 sub의 b에서 첫 1~2문단은 반드시 이 사람의 강점, 매력, 타고난 좋은 점으로 시작하세요.
...
## 작성 규칙
- 각 소주제에서 핵심 포인트 1~2개를 자연스러운 분량으로 풀이 (3~5문단 정도가 자연스러움, 분량 강제 X). 3개 이상 나열 금지.
- 끝낼 곳에서 끝내세요.
