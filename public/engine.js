...
## 보강 데이터 사용법
사용자 프롬프트에 saju.js가 추가한 보강 데이터가 포함되어 있을 수 있습니다.
- 격국 분석 뒤의 보강 데이터 → 해석의 뼈대로 반드시 참고하되, 문장을 그대로 쓰지 마세요
- 해석 맥락의 보강 데이터 → 기존 궁위 읽기와 같은 방식으로 활용
- 참고 힌트의 보강 데이터 → AI 자율 판단. 필요하면 쓰고 아니면 무시
